    ...
    >
      <div className="nav-upper">
        ...
        <div className="nav-menu">
          ...
          <NavLink to={"/invoices"}  className={'text-decoration-none'}>
            <ButtonComponent
              type={"button"}
              className={isExpanded ? "btn-sidebar" : "btn-sidebar-NX"}
          ...
          <NavLink to={"/onlineClass"}  className={'text-decoration-none'}>
            <ButtonComponent
              type={"button"}
              className={isExpanded ? "btn-sidebar" : "btn-sidebar-NX"}
              buttonName={isExpanded ? "Online Class" : ""}
              imgUrlStart={Icon5Bookingclass}
              imgClassName={
                isExpanded ? "btn-sidebar-icon" : "btn-sidebar-icon-NX"
              }
          ...
          <NavLink to={"/feedback"}  className={'text-decoration-none'}>
            <ButtonComponent
              type={"button"}
              className={isExpanded ? "btn-sidebar" : "btn-sidebar-NX"}
